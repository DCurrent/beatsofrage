...
*/
static void ps_bothclip(int x, int y, int width, int height, unsigned long *linetab, char *dest_c){
...
/*
	...
	- Vertical clipping adjustments have been performed, if necessary.
*/
static void ps_rightclip(int x, int y, int width, int height, unsigned long *linetab, char *dest_c){
...
/*
	...
	- Vertical clipping adjustments have been performed, if necessary.
*/
static void ps_leftclip(int x, int y, int width, int height, unsigned long *linetab, char *dest_c){
...
*/
static void ps_remap_bothclip(int x, int y, int width, int height, unsigned long *linetab, char *dest_c, char *lut){
...
*/
static void ps_remap_rightclip(int x, int y, int width, int height, unsigned long *linetab, char *dest_c, char *lut){
...
*/
static void ps_remap_leftclip(int x, int y, int width, int height, unsigned long *linetab, char *dest_c, char *lut){
...
/*
	Now with blending...
*/
static void ps_blend_bothclip(int x, int y, int width, int height, unsigned long *linetab, char *dest_c, char *lut){
...
/*
	...
	Same as above, blah blah.
*/
static void ps_blend_rightclip(int x, int y, int width, int height, unsigned long *linetab, char *dest_c, char *lut){
...
/*
	Left clipping for remap.
*/
static void ps_blend_leftclip(int x, int y, int width, int height, unsigned long *linetab, char *dest_c, char *lut){
